...
//        gl.locations = @[@(0), @(1.0f)];
    ...
    NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:@"新用户注册"attributes: @{NSFontAttributeName: UIFontSemibold(22), NSForegroundColorAttributeName: [UIColor colorWithRed:17/255.0 green:17/255.0 blue:17/255.0 alpha:1]}];
    ...
    LoginTextField *passT2 = [[LoginTextField alloc] init];
    passT2.title = @"密码";
    passT2.placehouder = @"请再次输入您的密码";
    [self.view addSubview:passT2];
    ...
    [passT2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(24);
        make.right.mas_equalTo(-24);
        make.top.mas_equalTo(passT.mas_bottom);
        make.height.mas_equalTo(60);
    }];
    
    {
        ...
        [btn mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(24);
            make.top.mas_equalTo(passT2.mas_bottom).offset(20);
    ...
    
    {
        ...
        NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:@"注册"attributes: @{NSFontAttributeName: UIFont(16),NSForegroundColorAttributeName: [UIColor colorWithRed:17/255.0 green:17/255.0 blue:17/255.0 alpha:1]}];
        label.attributedText = string;
        label.textColor = [UIColor colorWithRed:17/255.0 green:17/255.0 blue:17/255.0 alpha:1];
